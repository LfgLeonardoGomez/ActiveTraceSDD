...
import type { Materia, MateriaCreate } from '../../types/estructura.types';
...
export default function MateriaForm({ item, onSubmit, onCancel, isLoading }: MateriaFormProps) {
  const {
    register,
    handleSubmit,
    reset,
  ...
  const handleFormSubmit = (data: FormData) => {
    onSubmit(data as MateriaCreate);
  };

  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-base">{item ? 'Editar materia' : 'Nueva materia'}</CardTitle>
      </CardHeader>
      <CardContent>
