...
class AuditAction(StrEnum):
    ...
    TAREA_ESTADO_CAMBIAR = "TAREA_ESTADO_CAMBIAR"
    TAREA_APROBAR = "TAREA_APROBAR"
    TAREA_DEVOLVER = "TAREA_DEVOLVER"
    TAREA_DELEGAR = "TAREA_DELEGAR"
    TAREA_COMENTAR = "TAREA_COMENTAR"
    TAREA_COMENTARIO_ELIMINAR = "TAREA_COMENTARIO_ELIMINAR"
    PROGRAMA_CREAR = "PROGRAMA_CREAR"
